...
class PerformanceLogger:
    ...
    def info(self, operation: str, duration_ms: float = 0.0, message: str = "", **extra: Any) -> None:
        """Log info message with optional duration."""
        self._log_with_duration(logging.INFO, operation, duration_ms, message, **extra)
    
    def warning(self, operation: str, duration_ms: float = 0.0, message: str = "", **extra: Any) -> None:
        """Log warning message with optional duration."""
        self._log_with_duration(logging.WARNING, operation, duration_ms, message, **extra)
    
    def error(self, operation: str, duration_ms: float = 0.0, message: str = "", **extra: Any) -> None:
        """Log error message with optional duration."""
        self._log_with_duration(logging.ERROR, operation, duration_ms, message, **extra)
    
    def debug(self, operation: str, duration_ms: float = 0.0, message: str = "", **extra: Any) -> None:
        """Log debug message with optional duration."""
        self._log_with_duration(logging.DEBUG, operation, duration_ms, message, **extra)


def timed_operation(operation_name: Optional[str] = None, logger_name: Optional[str] = None):
    """
...
def log_operation(
    ...
    **extra: Any
    ...
    getattr(perf_logger, level.lower())(operation, duration_ms=0.0, message=message, **extra)
