...
class TestCycleDetection:
    ...
    def test_circular_folder_reference(self):
        ...
        scan_response = ScanResponse(
            ...
            stats=DriveStats(
                total_files=2, total_size=3000, folder_count=2, file_count=0
            ),
        )
...
class TestDepthLimiting:
    ...
    def test_deep_hierarchy(self):
        ...
        scan_response = ScanResponse(
            ...
            children_map=children_map,
            stats=DriveStats(
                total_files=100, total_size=100000, folder_count=100, file_count=0
            ),
        )
        ...
        assert (
            len(scan_response.children_map) == 99
        )  # 99 parents (folder_0 has no parent)
...
class TestLargeDataset:
    ...
    def test_large_file_list(self):
        ...
        scan_response = ScanResponse(
            ...
            children_map={},
            stats=DriveStats(
                total_files=10000, total_size=10000000, folder_count=0, file_count=10000
            ),
        )
...
class TestEdgeCases:
    ...
    def test_empty_files(self):
        ...
        scan_response = ScanResponse(
            files=[],
            children_map={},
            stats=DriveStats(total_files=0, total_size=0, folder_count=0, file_count=0),
        )
    ...
    def test_files_without_size(self):
        ...
        scan_response = ScanResponse(
            files=files,
            children_map={},
            stats=DriveStats(total_files=1, total_size=0, folder_count=0, file_count=1),
        )
    ...
    def test_multiple_parents(self):
        ...
        children_map = {"folder1": ["file1"], "folder2": ["file1"]}

        scan_response = ScanResponse(
            files=files,
            children_map=children_map,
            stats=DriveStats(
                total_files=1, total_size=1000, folder_count=0, file_count=1
            ),
        )
