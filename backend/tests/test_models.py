...
import pytest
from backend.models import FileItem, DriveStats, ScanResponse, HealthResponse
...
class TestFileItem:
    ...
    def test_file_item_minimal(self):
        ...
        file_item = FileItem(id="minimal_id", name="minimal.txt", mimeType="text/plain")
...
class TestDriveStats:
    ...
    def test_drive_stats_creation(self):
        ...
        stats = DriveStats(
            total_files=100, total_size=1048576, folder_count=10, file_count=90
        )
...
class TestScanResponse:
    ...
    def test_scan_response_creation(self, sample_files):
        ...
        stats = DriveStats(
            total_files=5, total_size=1051648, folder_count=2, file_count=3
        )
